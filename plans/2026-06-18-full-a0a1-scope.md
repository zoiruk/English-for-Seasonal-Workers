...
- [x] **Разговорник выживания** — отдельный экран из хаба, 6 категорий / 62 фразы (work/shop/
  ...
  (адверсариальная проверка безопасности 3 высокоответственных категорий health/SOS/documents —
  долг закрыт). Низкорисковые understand/work/shop адверсариально НЕ прогонялись (низкий приоритет).
