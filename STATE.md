...
- `CACHE_VERSION` esw-v71→**esw-v73** (гл.16 коммичена отдельно как эталон, v72; гл.17–23 — v73).
  **🎉 A2 «level-up» закрыт целиком (Фазы 1–3). Весь A2-контент построен 4-слойным гейтом.** Открытый риск №1 —
  живой A0-тест Б — по-прежнему НЕ проведён (снят с приоритета №1 владельцем 2026-06-24, остаётся реальным).
