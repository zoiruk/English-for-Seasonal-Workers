  ...
  const PHRASEBOOK = [
    {
      ...
      phrases: [
        ...
        { en: "Do you speak Russian?", transcr: "Ду ю спик рашн?", ru: "Вы говорите по-русски?" },
    ...
    },
    {
      ...
      phrases: [
        ...
        { en: "I've finished.", transcr: "Айв финишт.", ru: "Я закончил." },
    ...
    },
    {
      ...
      phrases: [
        ...
        { en: "Have you got change?", transcr: "Хэв ю гот чэйндж?", ru: "У вас есть сдача?" },
    ...
    },
    {
      ...
      phrases: [
        ...
        { en: "I have a pain here.", transcr: "Ай хэв э пэйн хиэ.", ru: "У меня здесь болит." },
        { en: "I need medicine.", transcr: "Ай нид мэдсин.", ru: "Мне нужно лекарство." },
        { en: "Where is the pharmacy?", transcr: "Уэа из зэ фармэси?", ru: "Где аптека?" },
        ...
        { en: "I have a temperature.", transcr: "Ай хэв э тэмпричэ.", ru: "У меня температура." },
    ...
    },
    {
      ...
      phrases: [
        ...
        { en: "I don't have it with me.", transcr: "Ай доунт хэв ит уиз ми.", ru: "У меня нет с собой." },
        { en: "Can you help me with this form?", transcr: "Кэн ю хэлп ми уиз зис форм?", ru: "Поможете заполнить форму?" },
        { en: "I don't understand this paper.", transcr: "Ай доунт андэстэнд зис пэйпэ.", ru: "Я не понимаю эту бумагу." },
        ...
        { en: "What is my National Insurance number?", transcr: "Уот из май нэшнл иншуэрэнс намбэ?", ru: "Какой у меня номер NI (National Insurance)?" },
    ...
    },
    {
      ...
      phrases: [
        ...
        { en: "There is a fire!", transcr: "Зэа из э файэ!", ru: "Пожар!" },
        { en: "There is an accident.", transcr: "Зэа из эн эксидэнт.", ru: "Произошёл несчастный случай." },
        { en: "I need help now.", transcr: "Ай нид хэлп нау.", ru: "Мне срочно нужна помощь." },
        { en: "Someone is hurt.", transcr: "Самуан из хёт.", ru: "Человек ранен." },
